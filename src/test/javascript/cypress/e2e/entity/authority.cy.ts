...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'd56fcb5e-f992-4130-88e8-a6eac574e4e6' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('e6ca096d-f5a5-4f13-9f07-bb2063a40dcb');
      cy.get(`[data-cy="name"]`).should('have.value', 'e6ca096d-f5a5-4f13-9f07-bb2063a40dcb');
